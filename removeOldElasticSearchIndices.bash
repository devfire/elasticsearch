...
#It computes the current date - 31 days. The index format must be YYYY.MM.DD
###########################################################################################
#
...
do
        #echo curl -XDELETE "$esURL"/"$index" || { echo "ERROR: $index is not found. Exiting."; exit 1; }
        ...
        #if the index date is LESS THAN the cut off date, delete it
